...
echo -e
curl -X POST -H "Accept:application/json" -H "Content-type:application/json" http://localhost:5000/persons -d'{"id":3, "ipn":"2000000048", "firstName":"wer", "lastName":"fgt", "sex":"MALE"}'
echo -e
